...
def build(args):
    ...
    # 可选：额外安全参数（避免 UPX 带来的问题），这里不默认使用 UPX
    # cmd.append("--noupx")
...
def parse_args():
    ...
    # 兼容性：如果指定 --onedir 则 onefile=False
